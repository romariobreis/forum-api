...
describe('Fetch Question Answers', () => {
  ...
  it('should be able to fetch question answers', async () => {
    ...
    const { answers } = await sut.execute({ questionId: 'dbab5e10-eab5-4f0c-8b87-2557727ff9f2', page: 1 })
  ...
  it('should be able to fetch paginated question answers', async () => {
    ...
    const { answers } = await sut.execute({ questionId: 'dbab5e10-eab5-4f0c-8b87-2557727ff9f2', page: 2 })
